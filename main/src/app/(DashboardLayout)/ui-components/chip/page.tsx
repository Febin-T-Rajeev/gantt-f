          ...
          <Grid item xs={12} display="flex" alignItems="stretch">
            <ChildCard title="Filled">
              <InlineItemCard>
                ...
                <Chip avatar={<Avatar alt="Natacha" src={"/images/users/1.jpg"} />} label="Primary Filled" color="primary" />
                <Chip avatar={<Avatar alt="Natacha" src={"/images/users/1.jpg"} />} label="Primary Deletable" color="primary" onDelete={handleDelete} />
                ...
                <Chip avatar={<Avatar alt="Natacha" src={"/images/users/2.jpg"} />} label="Default Filled" color="success" />
                <Chip avatar={<Avatar alt="Natacha" src={"/images/users/2.jpg"} />} label="Default Deletable" color="success" onDelete={handleDelete} />
                ...
                <Chip avatar={<Avatar alt="Natacha" src={"/images/users/3.jpg"} />} label="Default Filled" color="error" />
                <Chip avatar={<Avatar alt="Natacha" src={"/images/users/3.jpg"} />} label="Default Deletable" color="error" onDelete={handleDelete} />
              </InlineItemCard>
            </ChildCard>
          </Grid>
          <Grid item xs={12} display="flex" alignItems="stretch">
            <ChildCard title="Outlined">
              <InlineItemCard>
                ...
                <Chip variant="outlined" avatar={<Avatar alt="Natacha" src={"/images/users/1.jpg"} />} label="Default Filled" color="primary" />
                <Chip variant="outlined" avatar={<Avatar alt="Natacha" src={"/images/users/1.jpg"} />} label="Default Deletable" color="primary" onDelete={handleDelete} />
                ...
                <Chip variant="outlined" avatar={<Avatar alt="Natacha" src={"/images/users/2.jpg"} />} label="Default Filled" color="success" />
                <Chip variant="outlined" avatar={<Avatar alt="Natacha" src={"/images/users/2.jpg"} />} label="Default Deletable" color="success" onDelete={handleDelete} />
                ...
                <Chip variant="outlined" avatar={<Avatar alt="Natacha" src={"/images/users/3.jpg"} />} label="Default Filled" color="error" />
                <Chip variant="outlined" avatar={<Avatar alt="Natacha" src={"/images/users/3.jpg"} />} label="Default Deletable" color="error" onDelete={handleDelete} />
              </InlineItemCard>
            </ChildCard>
          </Grid>
