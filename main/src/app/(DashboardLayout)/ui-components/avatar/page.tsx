      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} lg={4} sm={6} display="flex" alignItems="stretch">
          <ChildCard title="Grouped Size">
            <Stack direction="row" spacing={1} justifyContent="center">
              <AvatarGroup max={4}>
                <Avatar alt="Remy Sharp" sx={{ width: 56, height: 56 }} src={"/images/users/1.jpg"} />
                <Avatar alt="Travis Howard" sx={{ width: 56, height: 56 }} src={"/images/users/2.jpg"} />
                <Avatar alt="Cindy Baker" sx={{ width: 56, height: 56 }} src={"/images/users/3.jpg"} />
              </AvatarGroup>
            </Stack>
          </ChildCard>
        </Grid>
            ...
            <Stack direction="row" spacing={1} justifyContent="center">
              <AvatarGroup>
                <Badge
                  ...
                  badgeContent={
                    <Avatar sx={{ width: 22, height: 22 }} alt="Remy Sharp" src={"/images/users/1.jpg"} />
                  }
                >
        ...
        <Grid item xs={12} lg={8} sm={6} display="flex" alignItems="stretch">
          <ChildCard title="Sizes">
            <Stack direction="row" spacing={1} justifyContent="center">
              <Avatar alt="Remy Sharp" src={"/images/users/1.jpg"} sx={{ width: 24, height: 24 }} />
              <Avatar alt="Remy Sharp" src={"/images/users/1.jpg"} sx={{ width: 32, height: 32 }} />
              <Avatar alt="Remy Sharp" src={"/images/users/1.jpg"} />
              <Avatar alt="Remy Sharp" src={"/images/users/1.jpg"} sx={{ width: 50, height: 50 }} />
              <Avatar alt="Remy Sharp" src={"/images/users/1.jpg"} sx={{ width: 60, height: 60 }} />
              <Avatar alt="Remy Sharp" src={"/images/users/1.jpg"} sx={{ width: 65, height: 65 }} />
            </Stack>
          </ChildCard>
        </Grid>
      </Grid>
