...
import PaymentGateways from "@/app/(DashboardLayout)/components/widgets/cards/PaymentGateways";
import RecentTransactions from "@/app/(DashboardLayout)/components/widgets/cards/RecentTransactions";
